...
DEFAULT_EXCLUDE_KEYWORDS = ["reseller", "resale", "wholesale", "bulk", "lot", "5 paar", "set", "pack", "bundle",
                            "printed", "S M L", "S M L XL", "barbie", "disney", "mattel", "doll", "toy", "faux", "fake"]
...
def search_ebay(query, max_results=1500, min_score = 3):
    ...
    results = ebay_api.search_items(query, max_results=max_results, marketplace = ['EBAY_FR', 'EBAY_IT', 'EBAY_DE', 'EBAY_AT', 'EBAY_GB'])
